...
<head>
  ...
  <title>JaceTrack - Customer Dashboard</title>
...
<div class="d-flex">
  ...
  <aside class="sidebar" id="sidebar">
    ...
    <nav class="nav flex-column">
      ...
      <a class="nav-link" href="{{ route('orders') }}"><i class="bx bx-package me-2"></i> My Orders</a>
  ...
  <div class="flex-grow-1">
    ...
    <header class="topbar">
      <div class="left">
        ...
        <img src="{{ asset('images/jacelogoclean.png') }}" alt="JaceTrack logo" />
       <div>
    <h6 class="m-0">Customer Dashboard</h6>
    <small class="text-muted">
        Welcome back, {{ Auth::user()->first_name ?? 'Customer' }}!
    </small>
</div>
      </div>
    ...
    <main class="container-fluid p-4">
      <div class="row g-3">
        ...
        <div class="col-12 col-md-4">
          <div class="dashboard-card">
            <div class="dashboard-title">Orders in Progress</div>
            <div class="d-flex justify-content-between align-items-end">
              <div>
                <h2 class="text-primary mb-0">{{ $inProgress }}</h2>
        ...
        <div class="col-12 col-md-4">
          <div class="dashboard-card">
            ...
            <div class="d-flex justify-content-between align-items-end">
              ...
              <i class="bx bx-check-shield fs-1 text-muted"></i>
            </div>
          </div>
        </div>
        ...
        <div class="col-12 col-md-4">
          <div class="dashboard-card">
            <div class="dashboard-title">Exceptions</div>
            <div class="d-flex justify-content-between align-items-end">
              <div>
                <h2 class="text-danger mb-0">{{ $exceptions }}</h2>
                <small class="text-muted">Issues to resolve</small>
              </div>
              <i class="bx bx-error fs-1 text-muted"></i>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="d-flex justify-content-between align-items-center mb-3 mt-4">
        <div class="dashboard-title">Recent Orders</div>
        <div>
          <a href="{{ url('shipment') }}" class="btn btn-lg btn-primary me-2">
